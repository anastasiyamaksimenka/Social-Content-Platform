...
//  Blog
//
//  Created by Anastasiya Maksimenka on 10/02/2024.
//
...
class PostPreviewTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        postTitleLabel.frame = CGRect(
            x: postImageView.frame.maxX+5,
            y: 5,
            width: contentView.frame.width-5-separatorInset.left-postImageView.frame.width,
            height: contentView.frame.height-10
        )
    }
